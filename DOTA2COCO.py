...
# wordname_15 = ['plane', 'ship', 'storage-tank']

# 按照RST的顺序
wordname_15 = ['plane', 'storage-tank', 'ship']


def DOTA2COCO(srcpath, destfile):
    imageparent = os.path.join(srcpath, 'images')
    labelparent = os.path.join(srcpath, 'common_ann')
    ...
    #        'version': '1.0',
    #        'year': 2018}
    info = {'contributor': 'orient',
           'data_created': '2024',
           'description': 'This is version of XVIEW & DOTA dataset.',
           'url': 'http://captain.whu.edu.cn/DOTAweb/',
           'version': '1.0',
           'year': 2024}
    data_dict['info'] = info
...
if __name__ == '__main__':
    dataset_name = ["xview_train", "dota_train", "dota_val"]
    for name in dataset_name:
        DOTA2COCO(fr'E:\Dataset\Split\{name}', fr'E:\Dataset\Split\{name}\RST_formatted_coco.json')
        print(name, " DONE!")
